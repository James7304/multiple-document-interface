...
*Note: All parameters of tabid is the individual ID given to each tab. For more details, see [Creating Tabs](https://github.com/James7304/multiple-document-interface/edit/main/README.md#creating-tabs).*
...
*Note: All parameters of tabid is the individual ID given to each tab. For more details, see [#create-tabs](https://github.com/James7304/multiple-document-interface/blob/main/README.md#creating-tabs).
